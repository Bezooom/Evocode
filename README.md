...
|----------------|----------|
| **Текущая версия** | **1.0.0** — Production Release |
| **Текущая фаза** | **1.0.0 DoD ✅** (Production Ready) |
...
> v1.0.0 — официальный промышленный релиз AI-IDE: режим оператора, независимая память агента, DLP-защита, адаптивный слой самообучения маленькой модели, автокраулер Git-навыков и конвертер Cursor rules (`.cursorrules`, `.mdc`), дуал-режим локального инференса (chat 35B + FIM).
