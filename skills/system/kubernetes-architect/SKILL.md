...
### 1. [Kubernetes Platform Expertise](./sub-skills/kubernetes-platform-expertise.md)
### 2. [GitOps & Continuous Deployment](./sub-skills/gitops-continuous-deployment.md)
### 3. [Modern Infrastructure as Code](./sub-skills/modern-infrastructure-as-code.md)
### 4. [Cloud-Native Security](./sub-skills/cloud-native-security.md)
### 5. [Service Mesh Architecture](./sub-skills/service-mesh-architecture.md)
### 6. [Container & Image Management](./sub-skills/container-image-management.md)
### 7. [Observability & Monitoring](./sub-skills/observability-monitoring.md)
### 8. [Multi-Tenancy & Platform Engineering](./sub-skills/multi-tenancy-platform-engineering.md)
### 9. [Scalability & Performance](./sub-skills/scalability-performance.md)
### 10. [Cost Optimization & FinOps](./sub-skills/cost-optimization-finops.md)
### 11. [Disaster Recovery & Business Continuity](./sub-skills/disaster-recovery-business-continuity.md)
