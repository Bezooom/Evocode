...
### 2. [2. Initialize Project with pnpm](./sub-skills/2-initialize-project-with-pnpm.md)
### 3. [3. Generate Next.js Project Structure](./sub-skills/3-generate-nextjs-project-structure.md)
### 4. [4. Generate React + Vite Project Structure](./sub-skills/4-generate-react-vite-project-structure.md)
### 5. [5. Generate Node.js API Project Structure](./sub-skills/5-generate-nodejs-api-project-structure.md)
### 6. [6. Generate TypeScript Library Structure](./sub-skills/6-generate-typescript-library-structure.md)
