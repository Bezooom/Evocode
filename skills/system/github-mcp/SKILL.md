...
### 1. [`create_issue`](./sub-skills/create_issue.md)
### 2. [`get_file_contents`](./sub-skills/get_file_contents.md)
### 3. [`create_pull_request`](./sub-skills/create_pull_request.md)
### 4. [`push_files`](./sub-skills/push_files.md)
