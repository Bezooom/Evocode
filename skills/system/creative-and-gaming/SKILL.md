...
# MACRO-SKILL: CREATIVE-AND-GAMING
This is a superset of the following micro-skills: codex-hermes-agent-main--skills--creative--songwriting-and-ai-music, codex-ace-step-skills-main--skills--acestep-lyrics-transcription, codex-ace-step, codex-hermes-agent-main--skills--media--songsee, codex-agents-main--plugins--game-development--skills--unity-ecs-patterns, codex-hermes-agent-main--optional-skills--creative--meme-generation, codex-ace-step-skills-main--skills--acestep-docs, codex-ace-step-skills-main--skills--acestep-simplemv, codex-hermes-agent-main--skills--creative--manim-video, codex-contributed-skills--skills--ace-step, codex-hermes-agent-main--skills--media--heartmula, codex-hermes-agent-main--skills--creative--popular-web-designs, codex-ace-step-skills-main--skills--acestep-songwriting, codex-hermes-agent-main--skills--creative--p5js, codex-agents-main--plugins--game-development--skills--godot-gdscript-patterns, codex-ace-step-skills-main--skills--acestep-thumbnail, codex-test-outputs--compiled-skills--ace-step, codex-hermes-agent-main--skills--social-media--xitter, codex-hermes-agent-main--skills--creative--ascii-video, codex-ace-step-skills-main--skills--acestep, codex-hermes-agent-main--skills--creative--excalidraw, codex-hermes-agent-main--skills--media--youtube-content, codex-hermes-agent-main--skills--media--gif-search, codex-hermes-agent-main--skills--creative--ascii-art

## Component: codex-hermes-agent-main--skills--creative--songwriting-and-ai-music
...
---
## Component: codex-ace-step-skills-main--skills--acestep-lyrics-transcription
...
---
## Component: codex-ace-step

---
name: ace-step
description: Генерация музыки и управление проектами ACE Step через веб-интерфейс http://127.0.0.1:7860/. Используется для создания песен, альбомов, генерации музыкальных композиций по текстовым описаниям.
---
...
---
## Component: codex-hermes-agent-main--skills--media--songsee
...
---
## Component: codex-agents-main--plugins--game-development--skills--unity-ecs-patterns
...
---
## Component: codex-hermes-agent-main--optional-skills--creative--meme-generation
...
---
## Component: codex-ace-step-skills-main--skills--acestep-docs
...
---
## Component: codex-ace-step-skills-main--skills--acestep-simplemv
...
---
## Component: codex-hermes-agent-main--skills--creative--manim-video
...
---
## Component: codex-contributed-skills--skills--ace-step
...
---
## Component: codex-hermes-agent-main--skills--media--heartmula
...
---
## Component: codex-hermes-agent-main--skills--creative--popular-web-designs
...
---
## Component: codex-ace-step-skills-main--skills--acestep-songwriting
...
---
## Component: codex-hermes-agent-main--skills--creative--p5js
...
---
## Component: codex-agents-main--plugins--game-development--skills--godot-gdscript-patterns
...
---
## Component: codex-ace-step-skills-main--skills--acestep-thumbnail
...
---
## Component: codex-test-outputs--compiled-skills--ace-step
...
**Role**: Integrated system skill for comprehensive ace step.
...
---
## Component: codex-hermes-agent-main--skills--social-media--xitter
...
---
## Component: codex-hermes-agent-main--skills--creative--ascii-video
...
---
## Component: codex-ace-step-skills-main--skills--acestep
...
---
## Component: codex-hermes-agent-main--skills--creative--excalidraw
...
---
## Component: codex-hermes-agent-main--skills--media--youtube-content
...
---
## Component: codex-hermes-agent-main--skills--media--gif-search
...
---
## Component: codex-hermes-agent-main--skills--creative--ascii-art
