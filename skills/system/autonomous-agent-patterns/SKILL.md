...
### 11. [5.1 Context Injection Patterns](./sub-skills/51-context-injection-patterns.md)
### 12. [5.2 Checkpoint/Resume](./sub-skills/52-checkpointresume.md)
### 13. [6.1 MCP Server Pattern](./sub-skills/61-mcp-server-pattern.md)
### 14. [Agent Design](./sub-skills/agent-design.md)
### 15. [Safety](./sub-skills/safety.md)
### 16. [UX](./sub-skills/ux.md)
