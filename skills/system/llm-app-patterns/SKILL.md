...
### 6. [2.1 ReAct Pattern (Reasoning + Acting)](./sub-skills/21-react-pattern-reasoning-acting.md)
...
### 10. [3.1 Prompt Templates with Variables](./sub-skills/31-prompt-templates-with-variables.md)
### 11. [3.2 Prompt Versioning & A/B Testing](./sub-skills/32-prompt-versioning-ab-testing.md)
...
### 15. [4.3 Evaluation Framework](./sub-skills/43-evaluation-framework.md)
### 16. [5.1 Caching Strategy](./sub-skills/51-caching-strategy.md)
### 17. [5.2 Rate Limiting & Retry](./sub-skills/52-rate-limiting-retry.md)
### 18. [5.3 Fallback Strategy](./sub-skills/53-fallback-strategy.md)
