...
**Дата:** 2026-07-19 | **Объект:** `/home/bezoom/storage/Projects/Evocode/src/`
...
- **Проблема:** Пути вида `/home/bezoom/llama.cpp/models/...` и `/home/bezoom/ik_llama.cpp/build/bin/llama-server` жёстко вшиты в defaultConfig. Код не переносим на другую машину/пользователя без правки исходников. ТЗ FR-01 требует `~/.config/evocode/models/`.
