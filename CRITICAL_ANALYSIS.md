...
**Дата:** 2026-07-20 · **Версия продукта:** 0.9.0 · **Фаза:** F3 (Hardening) Закрыта (RC1)  
**Примечание (2026-07-20):** Все ключевые security-находки ниже (DLP, Skill Sync, Auth, Bind) были успешно устранены и закрыты в рамках релиз-кандидата v0.9.0.
